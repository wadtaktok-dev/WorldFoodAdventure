...
enum class GameState { SPLASH, TUTORIAL, MENU, WORLD_MAP, ACHIEVEMENTS, HIGH_SCORES, SHOP, SETTINGS, DAILY_CHALLENGE, COUNTDOWN, PLAYING, PAUSED, LEVEL_COMPLETE, TREASURE_CHEST, GAME_OVER, FOOD_ALBUM, BOSS_INTRO, BOSS_BATTLE, BOSS_DEFEATED, WORLD_TRAVEL, LEVEL_UP, PROFILE, STATISTICS, GALLERY, MUSEUM_FOOD, MUSEUM_BOSS, MUSEUM_COUNTRIES, GALLERY_MUSIC, MEMORY_GALLERY, CHALLENGE_ARENA, DAILY_LOGIN, SEASONAL_EVENTS, FEEDBACK, FEEDBACK_HISTORY, PASSPORT, TV_TRAVEL }
