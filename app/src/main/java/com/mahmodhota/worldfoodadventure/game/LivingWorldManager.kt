    ...
    private fun spawnAnimal(screenWidth: Float, screenHeight: Float, countryId: String, bottomSafeZonePx: Float) {
        ...
        val emoji = when(chosenType) {
            "bird" -> when(countryId) {
                ...
                "japan" -> listOf("🦢", "🦆").random()
                "uk" -> listOf("🕊️", "🦆", "🦢").random()
                "netherlands" -> listOf("🦆", "🦢").random()
                "portugal" -> listOf("🦅", "🕊️").random()
                "austria" -> listOf("🦅", "🐦").random()
                "switzerland" -> listOf("🦅", "🐦").random()
                "egypt" -> listOf("🦅", "🕊️").random()
                "morocco" -> listOf("🦅", "🕊️").random()
                "kenya" -> listOf("🦅", "🐦").random()
                "ethiopia" -> listOf("🦅", "🐦").random()
                "south_korea" -> listOf("🐦", "🦅").random()
                "vietnam" -> listOf("🦢", "🕊️").random()
                "indonesia" -> listOf("🦜", "🕊️").random()
                "malaysia" -> listOf("🦜", "🕊️").random()
                "canada" -> listOf("🦅", "🦆", "🦢").random()
                "australia" -> listOf("🦜", "🦅", "🕊️").random()
                "new_zealand" -> listOf("🕊️", "🦆").random()
                "argentina", "chile", "peru" -> listOf("🦅", "🕊️").random()
            ...
            "ground" -> when(countryId) {
                ...
                "uk" -> listOf("🐕", "🐈", "🐿️", "🦊").random()
                "netherlands" -> listOf("🐕", "🐄", "🐇").random()
                "portugal" -> listOf("🐕", "🐈", "🦎").random()
                "austria" -> listOf("🦌", "🐿️", "🦊").random()
                "switzerland" -> listOf("🐄", "🦌", "🐿️").random()
                "egypt" -> listOf("🐪", "🐫", "🦎").random()
                "morocco" -> listOf("🐒", "🐪", "🐫").random()
                "kenya" -> listOf("🦒", "🐘", "🦓").random()
                "ethiopia" -> listOf("🐒", "🐏", "🐐").random()
                "south_korea" -> listOf("🐕", "🐈", "🦌").random()
                "vietnam" -> listOf("🐃", "🦢", "🐕").random()
                "indonesia" -> listOf("🐒", "🦜", "🦋").random()
                "malaysia" -> listOf("🐒", "🦜", "🦌").random()
                "canada" -> listOf("🦫", "🦌", "🐻", "🦊").random()
                "peru" -> listOf("🦙", "🐪", "🦎").random()
                "chile" -> listOf("🦌", "🦊", "🐧").random()
                "argentina" -> listOf("🏇", "🦊", "🐧").random()
                "australia" -> listOf("🦘", "🐨", "🦎").random()
                "new_zealand" -> listOf("🐑", "🐄", "🦌").random()
                else -> listOf("🐿️", "🐇").random()
            }
            else -> "🦋"
        }
